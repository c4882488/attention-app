...
export class Colors {
  ...
  rgba(p1, p2, p3, p4) {
    ...
    let red;
    let green;
    let blue; // Handle design token PlatformColor object
  ...
  getColorTint(colorValue, tintKey) {
    ...
    if (colorKey) {
      ...
      const key = this.shouldSupportDarkMode && Scheme.getSchemeType() === 'dark' ? colorKeys[colorKeys.length - 1 - keyIndex] : tintKey;
