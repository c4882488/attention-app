...
export interface SortableListProps<ItemT extends ItemWithId> extends Omit<FlatListProps<ItemT>, 'extraData' | 'data'>, Pick<SortableListContextType, 'scale'> {
    /**
...
declare const SortableList: <ItemT extends ItemWithId>(props: SortableListProps<ItemT>) => JSX.Element;
