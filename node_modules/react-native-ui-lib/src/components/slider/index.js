...
export default class Slider extends PureComponent {
  ...
  updateThumbStyle(start) {
    if (this.thumb.current && !this.props.disableActiveStyling) {
      ...
      this._thumbStyles.style = _omit(activeOrInactiveStyle, 'height', 'width');
      this.thumb.current?.setNativeProps(this._thumbStyles);
  ...
  onSeekStart() {
    _invoke(this.props, 'onSeekStart');
  }

  onSeekEnd() {
    _invoke(this.props, 'onSeekEnd');
  }
  ...
  onAccessibilityAction = event => {
    ...
    _invoke(AccessibilityInfo, 'announceForAccessibility', `New value ${newValue}`);
  };
  /* Renders */
  ...
  renderThumb = () => {
    ...
    return <Animated.View hitSlop={thumbHitSlop} ref={this.thumb} onLayout={this.onThumbLayout} {...this._panResponder.panHandlers} style={[styles.thumb, disabled && styles.disabledThumb, thumbStyle, {
  ...
  render() {
    ...
    return <View style={[styles.container, containerStyle]} onLayout={this.onContainerLayout} onAccessibilityAction={this.onAccessibilityAction} testID={testID} {...this.getAccessibilityProps()}>
        {_isFunction(renderTrack) ? <View style={[styles.track, {
        backgroundColor: maximumTrackTintColor
          ...
          backgroundColor: disabled ? INACTIVE_COLOR : maximumTrackTintColor
            ...
            <View ref={this.minTrack} style={[styles.track, trackStyle, styles.minimumTrack, Constants.isRTL && disableRTL && styles.trackDisableRTL, {
