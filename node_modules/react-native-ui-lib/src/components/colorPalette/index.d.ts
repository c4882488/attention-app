...
declare class ColorPalette extends PureComponent<Props, State> {
    ...
    renderColorSwatch(color: string, index: number): JSX.Element;
    renderPalette(props: Props, contentStyle: StyleProp<ViewStyle>, colors: string[], pageIndex: number): JSX.Element;
    renderScrollableContent(): JSX.Element;
    renderPaginationContent(): JSX.Element;
    render(): JSX.Element;
}
