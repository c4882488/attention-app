...
declare class SkeletonView extends Component<SkeletonViewProps, SkeletonState> {
    ...
    setAccessibilityProps(template?: Template): void;
    ...
    renderWithFading: (skeleton: any) => string | number | boolean | JSX.Element | React.ReactFragment | null | undefined;
    renderSkeleton(): string | number | boolean | JSX.Element | React.ReactFragment | null | undefined;
    renderNothing: () => null;
